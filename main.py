...
async def start_handler(_, event: Message):
    ...
    await event.reply_text(Config.START_MSG.format(event.from_user.mention),
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton("Our Channel", url="https://t.me/telegram"),
             InlineKeyboardButton("Our Group", url="https://t.me/telegram")],
        ...
        if "About_msg" in cb_data:
			...
			reply_markup=InlineKeyboardMarkup(
				[
					...
					[
						InlineKeyboardButton("Developer", url="https://t.me/hybrid_vamp"),
